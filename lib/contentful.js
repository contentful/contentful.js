...
export function createClient (params) {
  ...
  config.additionalTokens[params.space] = params.accessToken
  ...
  const contentfulApiBySpaceId = Object.entries(config.additionalTokens).reduce((acc, [spaceId, accessToken]) => {
