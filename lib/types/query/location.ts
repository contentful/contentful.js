...
type BaseLocationQueries<Fields,
  ...
  QueryFilter extends string = ''> = NonNullable<{
 ...
 */
export type ProximitySearchFilters<Fields, Prefix extends string> = BaseLocationQueries<Fields,
  Types,
 ...
 */
type BoundingBoxSearchFilters<Fields, Prefix extends string> = BaseLocationQueries<Fields,
  Types,
 ...
 * @see [Documentation]{@link https://www.contentful.com/developers/docs/references/content-delivery-api/#/reference/search-parameters/locations-in-a-bounding-object}
 */
type BoundingCircleSearchFilters<Fields, Prefix extends string> = BaseLocationQueries<Fields,
  Types,
