...
test('query', async () => {
  expectTypeOf<Required<EntryFieldsQueries<{ stringField: EntryFieldTypes.Text }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ numberField: EntryFieldTypes.Number }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ integerField: EntryFieldTypes.Integer }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ symbolField: EntryFieldTypes.Symbol }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ dateField: EntryFieldTypes.Date }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ locationField: EntryFieldTypes.Location }>>>({
  ...
  expectTypeOf<Required<EntryFieldsQueries<{ objectField: EntryFieldTypes.Object }>>>({
    select: ['fields.objectField'],
    'fields.objectField[exists]': mocks.booleanValue,
  })

  expectTypeOf<Required<EntryFieldsQueries<{ richTextField: EntryFieldTypes.RichText }>>>({
  ...
  expectTypeOf<
    Required<
      EntryFieldsQueries<{ arrayStringField: EntryFieldTypes.Array<EntryFieldTypes.Symbol> }>
    >
  >({
